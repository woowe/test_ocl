...
fn main() {
    if let Some(context) = Context.new(None, OCL_KERNEL) {
        println!("Computer has opencl installed!");
    } else {
        println!("Computer doesn't have opencl installed");
    }
}